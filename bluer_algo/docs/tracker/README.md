...
target tracking for a [ugv](../../../../bluer-ugv/bluer_ugv/docs/swallow/digital/algo) using [mean/cam-shift](https://docs.opencv.org/4.11.0/d7/d00/tutorial_meanshift.html).
