...
def test_bluer_algo_env():
    ...
    assert env.BLUER_ALGO_AI_AGENT_TRANSCRIPTION_ENDPOINT
    assert env.BLUER_ALGO_AI_AGENT_TRANSCRIPTION_TEST_OBJECT

    assert env.BLUER_ALGO_AI_AGENT_CHAT_ENDPOINT
    assert env.BLUER_ALGO_AI_AGENT_CHAT_TEST_OBJECT
