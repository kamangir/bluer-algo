...
def test_bluer_algo_env():
    ...
    assert env.BLUER_ALGO_AI_AGENT_S2T_MACHINE_USER_NAME

    assert env.BLUER_ALGO_AI_AGENT_S2T_API_KEY
    assert env.BLUER_ALGO_AI_AGENT_S2T_ENDPOINT

    assert env.BLUER_ALGO_AI_AGENT_S2T_TEST_OBJECT
